...
from ML.yolov7face.utils.general import check_requirements, xyxy2xywh, xywh2xyxy, xywhn2xyxy, xyn2xy, segment2box, segments2boxes, \
    resample_segments, clean_str
from ML.yolov7face.utils.torch_utils import torch_distributed_zero_first
...
class LoadImages:  # for inference
    def __init__(self, path, img_size=640, stride=32):
        ...
        if '*' in p:
            ...
            files = []
            for (dirpath, _, filenames) in os.walk(p[:-1]):
    ...
    def __next__(self):
        ...
        if self.video_flag[self.count]:
            ...
            print(f'image {self.count}/{self.nf}')
